		...
		private function keyShit():Void // I've invested in emma stocks
			{
				...
				if (SONG.mania == 1)
					{
						holdArray = [control.L1, control.U1, control.R1, control.L2, control.D1, control.R2];
						pressArray = [
							control.L1_P,
							control.U1_P,
							control.R1_P,
					...
					{
						holdArray = [control.N0, control.N1, control.N2, control.N3, control.N4, control.N5, control.N6, control.N7, control.N8];
						pressArray = [
							control.N0_P,
							control.N1_P,
							control.N2_P,
		...
		function goodNoteHit(note:Note, resetMashViolation = true):Void
			{
				...
				if (!note.wasGoodHit)
				{
					...
					if (note.noteType == 1) //fire note //zzz
						{
							health -= 0.45;
						}

					else if (note.noteType == 2) //halo note
						{
							health = 0;
						}
